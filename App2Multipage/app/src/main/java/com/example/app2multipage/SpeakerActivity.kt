...
class SpeakerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize Speaker Products
        setupProduct(R.id.product1, "OB-4 Speakers", "Red", 279.90, 4.0f, "600 Reviews", R.drawable.speakerproduct1)
        setupProduct(R.id.product2, "Audio Physic Classic 3 Speaker", "Brown", 5860.00, 5.0f, "170 Reviews", R.drawable.speakerproduct2)
