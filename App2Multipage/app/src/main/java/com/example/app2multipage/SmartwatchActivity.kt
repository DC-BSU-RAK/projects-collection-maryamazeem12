...
class SmartwatchActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize Products
        setupProduct(R.id.product1, "Apple Watch SE 3", "Black", 1599.00, 4.0f, "560 Reviews", R.drawable.smartwatchproduct1)
        setupProduct(R.id.product2, "Maxwell Health Smartwatch", "Pink", 435.00, 3.0f, "130 Reviews", R.drawable.smartwatchproduct2)
