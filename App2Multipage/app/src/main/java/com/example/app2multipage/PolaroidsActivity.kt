...
class PolaroidsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize Products
        setupProduct(R.id.product1, "Polaroid Go Instant Camera", "Purple", 399.00, 4.0f, "600 Reviews", R.drawable.polaroidproduct1)
        setupProduct(R.id.product2, "Instax Mini 12 Instant Camera", "Mint Green", 302.00, 3.0f, "170 Reviews", R.drawable.polaroidproduct2)
