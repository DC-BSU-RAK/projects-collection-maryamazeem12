...
class AirpodsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initialize Products
        setupProduct(R.id.product1, "JBL Wave Beam 2 Collection", "Pink", 299.90, 4.0f, "260 Reviews", R.drawable.productairpods1)
        setupProduct(R.id.product2, "Apple AirPods 4", "Pink", 799.90, 3.0f, "140 Reviews", R.drawable.airpodproduct2)
        setupProduct(R.id.product3, "Apple AirPods 4", "Black", 799.90, 5.0f, "500 Reviews", R.drawable.airpodproduct3)
    ...
    override fun onResume() {
        super.onResume()
        // Refresh favorite icons when returning to this page
        setupProduct(R.id.product1, "JBL Wave Beam 2 Collection", "Pink", 299.90, 4.0f, "260 Reviews", R.drawable.productairpods1)
        setupProduct(R.id.product2, "Apple AirPods 4", "Pink", 799.90, 3.0f, "140 Reviews", R.drawable.airpodproduct2)
        setupProduct(R.id.product3, "Apple AirPods 4", "Black", 799.90, 5.0f, "500 Reviews", R.drawable.airpodproduct3)
        setupProduct(R.id.product4, "Apple AirPods 4 Teal 16 Edition", "Teal", 799.90, 4.0f, "590 Reviews", R.drawable.airpodproduct4)
