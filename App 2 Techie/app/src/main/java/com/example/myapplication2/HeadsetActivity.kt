...
class HeadsetActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setupProduct(R.id.product1, "Airbuds Max Wireless", "White", 129.90, 3.0f, "100 Reviews", R.drawable.headsetproduct1, 1)
        setupProduct(R.id.product2, "AirPods Max Wireless Over-Ear Headphones", "Sky Blue", 1799.09, 4.0f, "200 Reviews", R.drawable.headsetproduct2, 2)
        setupProduct(R.id.product3, "JBL Tune 520BT Wireless On-Ear Headphones", "Purple", 197.00, 5.0f, "570 Reviews", R.drawable.headsetproduct3, 3)
        setupProduct(R.id.product4, "Beats Studio Wireless Headset", "Sandstone", 765.00, 4.0f, "590 Reviews", R.drawable.headsetproduct4)

        val categories = listOf(R.id.btn_cat_airpods, R.id.btn_cat_speakers, R.id.btn_cat_smartwatch, R.id.btn_cat_macbook)
        ...
        val productClickListener = View.OnClickListener {
            ...
            it.postDelayed({
                val intent = when(productIndex) {
                    1 -> Intent(this, Headset1InfoActivity::class.java)
                    2 -> Intent(this, Headset2InfoActivity::class.java)
                    3 -> Intent(this, Headset3InfoActivity::class.java)
                    else -> null
                }
                intent?.let { 
                    startActivity(it)
