...
class Airpod2InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private val productName = "Apple AirPods 4"
    private val productVariant = "Pink"
    private val productPrice = 799.90
    private val productImageResId = R.drawable.airpodproduct2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_airpod2_info)
