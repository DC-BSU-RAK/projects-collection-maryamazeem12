...
class Smartwatch2InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private lateinit var tvQuantity: TextView
    private val productName = "Maxwell Health Smartwatch"
    private val productVariant = "Pink"
    private val productPrice = 435.00
    private val productImageResId = R.drawable.smartwatch2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_smartwatch2_info)
