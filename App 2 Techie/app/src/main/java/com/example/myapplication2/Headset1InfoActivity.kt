...
class Headset1InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private val productName = "Airbuds Max Wireless Bluetooth Headphones"
    private val productVariant = "White"
    private val productPrice = 129.90
    private val productImageResId = R.drawable.headsetproduct1

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_headset1_info)
