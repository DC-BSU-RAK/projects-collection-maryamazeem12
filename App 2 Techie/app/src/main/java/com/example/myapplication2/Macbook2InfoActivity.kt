...
class Macbook2InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private lateinit var tvQuantity: TextView
    private val productName = "Apple 2026 MacBook Neo"
    private val productVariant = "Citrus"
    private val productPrice = 2559.00
    private val productImageResId = R.drawable.macbook2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_macbook2_info)
