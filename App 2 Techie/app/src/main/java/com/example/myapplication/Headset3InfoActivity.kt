...
class Headset3InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private val productName = "JBL Tune 520BT Wireless On-Ear Headphones"
    private val productVariant = "Purple"
    private val productPrice = 197.00
    private val productImageResId = R.drawable.headsetproduct3

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_headset3_info)
