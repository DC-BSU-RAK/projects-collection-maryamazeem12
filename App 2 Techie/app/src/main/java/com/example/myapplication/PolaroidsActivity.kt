...
class PolaroidsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_polaroids)
        ...
        // Initialize Products
        setupProduct(R.id.product1, "Polaroid Go Generation 2", "Purple", 296.00, 4.0f, "600 Reviews", R.drawable.polaroidproduct1, Polaroid1InfoActivity::class.java)
        setupProduct(R.id.product2, "Instax Fujifilm Mini 12 Instant Camera", "Mint Green", 302.00, 3.0f, "170 Reviews", R.drawable.polaroidproduct2, Polaroid2InfoActivity::class.java)
        setupProduct(R.id.product3, "Fujifilm INSTAX Mini Camera", "Black", 718.00, 5.0f, "570 Reviews", R.drawable.polaroidproduct3)

        // Category Navigation
        val categories = listOf(R.id.btn_cat_speakers, R.id.btn_cat_airpods, R.id.btn_cat_smartwatch, R.id.btn_cat_macbook)
