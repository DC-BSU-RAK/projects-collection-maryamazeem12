...
class Polaroid2InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private lateinit var tvQuantity: TextView
    private val productName = "Instax Fujifilm Mini 12 Instant Camera"
    private val productVariant = "Mint Green"
    private val productPrice = 302.00
    private val productImageResId = R.drawable.polaroid2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_polaroid2_info)
