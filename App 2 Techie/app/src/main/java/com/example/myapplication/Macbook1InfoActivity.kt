...
class Macbook1InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private lateinit var tvQuantity: TextView
    private val productName = "MacBook Air"
    private val productVariant = "Midnight"
    private val productPrice = 4559.00
    private val productImageResId = R.drawable.macbook1

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_macbook1_info)
