...
class Speaker2InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private val productName = "Audio Physic Classic 3 Speaker Pair"
    private val productVariant = "Wood Brown"
    private val productPrice = 3664.00
    private val productImageResId = R.drawable.speakerproduct2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_speaker2_info)
