...
class Headset2InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private val productName = "AirPods Max Wireless Over-Ear Headphones"
    private val productVariant = "Sky Blue"
    private val productPrice = 1799.09
    private val productImageResId = R.drawable.headsetproduct2

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_headset2_info)
