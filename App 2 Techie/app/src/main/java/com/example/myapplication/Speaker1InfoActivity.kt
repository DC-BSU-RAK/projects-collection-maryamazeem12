...
class Speaker1InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private val productName = "Teenage Engineering OB-4 Portable Speaker"
    private val productVariant = "Glossy Red"
    private val productPrice = 3664.00
    private val productImageResId = R.drawable.speakerproduct1

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_speaker1_info)
