...
class Polaroid1InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private lateinit var tvQuantity: TextView
    private val productName = "Polaroid Go Generation 2"
    private val productVariant = "Purple"
    private val productPrice = 296.00
    private val productImageResId = R.drawable.polaroid1

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_polaroid1_info)
