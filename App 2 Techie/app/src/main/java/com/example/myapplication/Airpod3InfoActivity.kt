...
class Airpod3InfoActivity : AppCompatActivity() {

    private var quantity = 0
    private val productName = "Apple AirPods 4 Black"
    private val productVariant = "Black"
    private val productPrice = 799.90
    private val productImageResId = R.drawable.airpodproduct3

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_airpod3_info)
